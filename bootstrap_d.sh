...
do_step "Install" "YAY" sudo pacman -S --needed git base-devel && git clone https://aur.archlinux.org/yay-bin.git && cd yay-bin && makepkg -si --noconfirm
...
do_step "Install" "Brightnesctl" yay -S brightnessctl --noconfirm
